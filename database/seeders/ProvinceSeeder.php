...
class ProvinceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('provinces')->insert([
            ...
            ['id' => 31, 'name' => 'DKI JAKARTA', 'alt_name' => 'DKI JAKARTA', 'latitude' => -6.173437, 'longitude' => 106.828284],
            ...
            ['id' => 34, 'name' => 'DI YOGYAKARTA', 'alt_name' => 'DI YOGYAKARTA', 'latitude' => -7.80139, 'longitude' => 110.36472],
